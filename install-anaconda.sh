...
/opt/anaconda/bin/conda install -y python==$PYTHON_VERSION
rm -rf anaconda.sh

cd /opt/anaconda
export PATH=/opt/anaconda/bin:$PATH
conda install mamba -c conda-forge -y
mamba install -c fastai -c pytorch -c conda-forge anaconda fastai jupyter fastbook voila jedi pytorch torchvision torchaudio cudatoolkit folium plotly scikit-learn matplotlib pandas anaconda-navigator jupyterlab tensorflow-gpu -y
